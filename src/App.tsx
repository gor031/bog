...
4. 서식: H1, H2, H3 태그를 적절히 사용하여 구조적인 마크다운(Markdown) 포맷으로 작성할 것. 마크다운 수평선(---)은 절대 넣지 마세요.
...
7. 금지 항목: "SEO 마케터의 Tip", 작성 후기, 글 작성을 어떻게 했는지(어떻게 최적화했는지)에 대한 설명은 절대 쓰지 마세요. 오직 사용자가 복사해서 바로 쓸 수 있게 블로그 포스팅 본문 내용만 출력하세요.
      `;
